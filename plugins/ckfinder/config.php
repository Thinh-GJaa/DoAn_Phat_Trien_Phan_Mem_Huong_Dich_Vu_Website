...
try {
    ...
    $resp = $client->request('GET', $app_url."/api/profile");
...
$config['licenseName'] = 'timeswriter.xyz';
 $config['licenseKey']  = 'QHNHC496JWFYGKT2HVAARGP1E9MEL';
// $config['licenseName'] = 'localhost//source-code';
// $config['licenseKey']  = '';
...
$config['backends'][] = array(
    ...
    'root'         => $_SERVER['DOCUMENT_ROOT']."/assets/uploads/",
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
