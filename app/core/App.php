    ...
    private function auth()
    {
        ...
        if(Input::cookie("accessToken")){
            ...
            $headers = [
                ...
                'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) coc_coc_browser/89.0.225 Chrome/99.0.4844.51 Safari/537.36',
            ];
            ...
            echo "Lỗi khi thực hiện yêu cầu cURL: " . curl_error($curl);
            } else {
...
curl_setopt($curl, CURLOPT_SSL_VERIFYHOST, false);
        ...
        $resp = @json_decode($response);
        if ($resp !== null) {
            // Kiểm tra nếu trường "result" tồn tại và có giá trị bằng 1
  ...
  // Kiểm tra giá trị của router
  //var_dump($router); // hoặc echo $router;
