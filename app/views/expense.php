...
<html id="locale" lang="<?= ACTIVE_LANG ?>">
   ...
   <body>
      ...
      <div class="main-panel"><!-- right screen -->
         ...
         <!-- content -->
         <?php require_once(APPPATH.'/views/fragments/expense.fragment.php'); ?>
         <!-- END content -->
            ...
            $('#edit').on('show.bs.modal', function(e) {
               ...
               $.ajax({
                  ...
                  success: function(resp) 
                  {
                     ...
                     if( resp.result )
                     {
                        $("#expensename").val(resp.data.name);
                        $("#expenseamount").val(resp.data.amount);
                        $("#expensereference").val(resp.data.reference);
                        $("#expenseaccount").val(resp.data.account_id);
                        $("#expensecategory").val(resp.data.category_id);
                        $('#expensecategory').trigger("change");
                        $("#edate").val(resp.data.transactiondate);
                        $("#expensenote").val(resp.data.description);
